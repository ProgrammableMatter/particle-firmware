...
#  define __TIMER1_INTERRUPT_OUTPUT_MODE_SETUP TCCR1A unsetBit \
    ((1 << COM1A1) | (1 << COM1A0) | (1 << COM1B1) | (1 << COM1B0))

#  define __TIMER1_INTERRUPT_WAVE_GENERATION_MODE_SETUP TCCR1A unsetBit ((1 << WGM11) | (1 << WGM10)); \
    TCCR1B unsetBit ((1 << WGM13) | (1 << WGM12));
#  define __TIMER1_INTERRUPT_COMPARE_VALUE_SETUP(compareValue) OCR1A = compareValue

#  define __TIMER1_INTERRUPT_PRESCALER_ENABLE TCCR1B setBit(__PRESCALER_8)
#  define __TIMER1_INTERRUPT_PRESCALER_DISABLE TCCR1B unsetBit((1 << CS02) | (0 << CS01) | (1 << CS00))

#  define __TIMER1_INTERRUPT_ENABLE TIMSK setBit bit(OCIE1A)
#  define __TIMER1_INTERRUPT_DISABLE TIMSK unsetBit bit(OCIE1A)
#else
#  error
#endif
...
#define TIMER_NEIGHBOUR_SENSE_SETUP __TIMER1_INTERRUPT_CLEAR_PENDING; \
    __TIMER1_INTERRUPT_OUTPUT_MODE_SETUP; \
    __TIMER1_INTERRUPT_WAVE_GENERATION_MODE_SETUP; \
    __TIMER1_INTERRUPT_COMPARE_VALUE_SETUP(__DEFAULT_NEIGHBOUR_SENSING_COMPARE_VALUE); \
    __TIMER1_INTERRUPT_PRESCALER_DISABLE; \
    __TIMER1_INTERRUPT_ENABLE

#define TIMER_NEIGHBOUR_SENSE_DISABLE __TIMER1_INTERRUPT_PRESCALER_DISABLE; __TIMER1_INTERRUPT_DISABLE
#define TIMER_NEIGHBOUR_SENSE_ENABLE __TIMER1_INTERRUPT_ENABLE; __TIMER1_INTERRUPT_PRESCALER_ENABLE
