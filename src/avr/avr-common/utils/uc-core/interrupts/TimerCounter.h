...
#  define __TIMER_1_TX_RX_SETUP __TIMER1_INTERRUPT_CLEAR_PENDING; \
    ...
    __TIMER1_INTERRUPT_COMPARE_VALUE_B_SETUP((DEFAULT_TX_RX_COMPARE_TOP_VALUE / TX_RX_COUNTER_CENTER_VALUE_DIVISOR) - TX_RX_COUNTER_CENTER_INTERRUPT_LATENCY_ADJUSTMENT); \
    __TIMER1_INTERRUPT_PRESCALER_DISABLE; \
...
#  ifdef __AVR_ATtiny1634__
#    define TIMER_TX_RX_COMPARE_TIMEOUT_VALUE (OCR0A)
#  else
#     define TIMER_TX_RX_COMPARE_TIMEOUT_VALUE (OCR0)
#  endif
...
// TODO: reception/transmission does not depend on __TIMER_0_TX_RX_SETUP, __TIMER_TX_RX_TIMEOUT_COUNTER_PRESCALER_ENABLE
...
#  define TIMER_TX_RX_SETUP __TIMER_1_TX_RX_SETUP; \
    TIMER_TX_RX_COUNTER_CLEAR_PENDING_INTERRUPTS;\
