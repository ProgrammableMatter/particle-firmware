...
#  define __TIMER1_OVERFLOW_INTERRUPT_ENABLE TIMSK setBit bit(TOIE1)
#  define __TIMER1_OVERFLOW_INTERRUPT_DISABLE TIMSK unsetBit bit(TOIE1)
#else
#  error
#endif
...
#  define __ACTUATOR_COUNTER_PRESCALER_ENABLE __TIMER0_INTERRUPT_PRESCALER_ENABLE(__PRESCALER_1)
#  define __ACTUATOR_COUNTER_PRESCALER_DISABLE __TIMER0_INTERRUPT_PRESCALER_DISABLE
...
#  define LOCAL_TIME_INTERRUPT_COUNTER_VALUE (TCNT0)
...
#  ifdef __AVR_ATtiny1634__
#    define LOCAL_TIME_INTERRUPT_COMPARE_VALUE (OCR0A)
#  else
#     define LOCAL_TIME_INTERRUPT_COMPARE_VALUE (OCR0)
#  endif

#  define ACTUATOR_INTERRUPT_PAUSE __TIMER0_INTERRUPT_PRESCALER_DISABLE
#  define ACTUATOR_INTERRUPT_DISABLE __TIMER0_INTERRUPT_PRESCALER_DISABLE
#  define ACTUATOR_INTERRUPT_RESUME __TIMER0_INTERRUPT_PRESCALER_ENABLE(__PRESCALER_1);
#  define ACTUATOR_INTERRUPT_ENABLE __TIMER0_INTERRUPT_PRESCALER_ENABLE(__PRESCALER_1);
