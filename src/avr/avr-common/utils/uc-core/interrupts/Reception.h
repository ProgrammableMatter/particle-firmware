...
#  define RX_NORTH_INTERRUPT_CLEAR_PENDING ((GIFR & bit(__RX_INTERRUPT_FLAG_NORTH)) != 0) ? GIFR = bit(__RX_INTERRUPT_FLAG_NORTH):0
#  define RX_EAST_INTERRUPT_CLEAR_PENDING ((GIFR & bit(__RX_INTERRUPT_FLAG_EAST)) != 0) ? GIFR = bit(__RX_INTERRUPT_FLAG_EAST):0
#  define RX_SOUTH_INTERRUPT_CLEAR_PENDING ((GIFR & bit(__RX_INTERRUPT_FLAG_SOUTH)) != 0) ? GIFR = bit(__RX_INTERRUPT_FLAG_SOUTH):0
