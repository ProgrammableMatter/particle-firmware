...
#  define RX_INTERRUPTS_CLEAR_PENDING_NORTH ((GIFR & bit(__RX_INTERRUPT_FLAG_NORTH)) != 0) ? GIFR = bit(__RX_INTERRUPT_FLAG_NORTH):0
#  define RX_INTERRUPTS_CLEAR_PENDING_EAST ((GIFR & bit(__RX_INTERRUPT_FLAG_EAST)) != 0) ? GIFR = bit(__RX_INTERRUPT_FLAG_EAST):0
#  define RX_INTERRUPTS_CLEAR_PENDING_SOUTH ((GIFR & bit(__RX_INTERRUPT_FLAG_SOUTH)) != 0) ? GIFR = bit(__RX_INTERRUPT_FLAG_SOUTH):0
