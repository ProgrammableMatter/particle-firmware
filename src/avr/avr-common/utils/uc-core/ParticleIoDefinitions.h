...
#define SOUTH_RX_SWITCH_HI SOUTH_RX_SWITCH_OUT setHi SOUTH_RX_SWITH_PIN
#define SOUTH_RX_SWITCH_LO SOUTH_RX_SWITCH_OUT setLo SOUTH_RX_SWITH_PIN
#define SOUTH_RX_SWITCH_IS_HI (0 != (SOUTH_RX_SWITCH_IN getBit SOUTH_RX_SWITH_PIN))
#define SOUTH_RX_SWITCH_IS_LO (0 == (SOUTH_RX_SWITCH_IN getBit SOUTH_RX_SWITH_PIN))
...
#define NORTH_RX_SWITCH_HI NORTH_RX_SWITCH_OUT setHi NORTH_RX_SWITH_PIN
#define NORTH_RX_SWITCH_LO NORTH_RX_SWITCH_OUT setLo NORTH_RX_SWITH_PIN
#define NORTH_RX_SWITCH_IS_HI (0 != (NORTH_RX_SWITCH_IN getBit NORTH_RX_SWITH_PIN))
#define NORTH_RX_SWITCH_IS_LO (0 == (NORTH_RX_SWITCH_IN getBit NORTH_RX_SWITH_PIN))
...
#ifdef __AVR_ATtiny20__
#  define SETUP_PORT_A_DIR ADir setOut (NORTH_TX_PIN | NORTH_RX_SWITCH_PIN | SOUTH_TX_PIN | SOUTH_RX_SWITCH_PIN | LED_PIN | TESTPOINT_PIN)
// is set per default: ADir setIn (NORTH_RX_PIN | SOUTH_RX_PIN)
#  define SETUP_PORT_DIR SETUP_PORT_A_DIR

#  define SETUP_PORT_A_PINS AOut setHi (NORTH_TX_PIN | SOUTH_TX_PIN | NORTH_SOUTH_RX_SWITCH_PIN | SOUTH_RX_SWITCH_PIN | NORTH_RX_PIN | SOUTH_RX_PIN)
// is set per default: ADir setLo (LED_PIN | TESTPOINT_PIN)
#  define SETUP_PORT_PINS SETUP_PORT_A_PINS

#elif __AVR_ATmega16__
#  define SETUP_PORT_A_DIR ADir setOut (NORTH_TX_PIN | NORTH_RX_SWITH_PIN | SOUTH_TX_PIN | SOUTH_RX_SWITH_PIN | LED_PIN | TESTPOINT_PIN)
// is set per default: DDir setIn (NORTH_RX_PIN | SOUTH_RX_PIN)
#  define SETUP_PORT_DIRS SETUP_PORT_A_DIR

#  define SETUP_PORT_A_PINS AOut setHi (NORTH_TX_PIN | NORTH_RX_SWITH_PIN | SOUTH_TX_PIN | SOUTH_RX_SWITH_PIN)
