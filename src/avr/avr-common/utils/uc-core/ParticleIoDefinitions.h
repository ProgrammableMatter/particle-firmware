...
#define SOUTH_RX SOUTH_RX_SWITCH_IN getBit SOUTH_RX_SWITCH_PIN
...
#define SOUTH_RX_SWITCH_IS_HI (0 != (SOUTH_RX))
#define SOUTH_RX_SWITCH_IS_LO (0 == (SOUTH_RX))
...
#define EAST_RX_IS_HI (0 != (EAST_RX_IN getBit EAST_RX_PIN))
#define EAST_RX_IS_LO (0 == (EAST_RX_IN getBit EAST_RX_PIN))
...
#define EAST_RX EAST_RX_SWITCH_IN getBit EAST_RX_SWITCH_PIN
...
#define EAST_RX_SWITCH_IS_HI (0 != (EAST_RX))
#define EAST_RX_SWITCH_IS_LO (0 == (EAST_RX))
