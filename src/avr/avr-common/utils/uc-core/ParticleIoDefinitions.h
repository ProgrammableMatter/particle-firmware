...
#define SOUTH_TX_IS_HI (0 != (SOUTH_TX))
#define SOUTH_TX_IS_LO (0 == (SOUTH_TX))
...
#define SOUTH_RX_IS_HI (SOUTH_RX)
#define SOUTH_RX_IS_LO (0 == SOUTH_RX)
...
#define SOUTH_RX_SWITCH (unsigned char)((0 == (SOUTH_RX_IN getBit SOUTH_RX_PIN)) ? 0 : 1)
...
#define SOUTH_RX_SWITCH_IS_HI (SOUTH_RX_SWITCH)
#define SOUTH_RX_SWITCH_IS_LO (0 == SOUTH_RX_SWITCH)
...
#define NORTH_RX (unsigned char)((0 == (NORTH_RX_IN getBit NORTH_RX_PIN)) ? 0 : 1)
#define NORTH_RX_PULL_UP NORTH_RX_OUT setHi NORTH_RX_PIN
#define NORTH_RX_PULL_DOWN NORTH_RX_OUT setLo NORTH_RX_PIN
#define NORTH_RX_IS_HI (NORTH_RX)
#define NORTH_RX_IS_LO (0 == NORTH_RX)
...
#define EAST_TX_SEND_HI EAST_TX_LO
#define EAST_TX_SEND_LO EAST_TX_HI
#define EAST_TX_IS_HI (0 != (EAST_TX_IN getBit EAST_TX_PIN))
#define EAST_TX_IS_LO (0 == (EAST_TX_IN getBit EAST_TX_PIN))
...
#define EAST_RX (unsigned char)((0 == (EAST_RX_IN getBit EAST_RX_PIN)) ? 0 : 1)
#define EAST_RX_PULL_UP EAST_RX_OUT setHi EAST_RX_PIN
#define EAST_RX_PULL_DOWN EAST_RX_OUT setLo EAST_RX_PIN
#define EAST_RX_IS_HI (EAST_RX)
#define EAST_RX_IS_LO (0 == EAST_RX)
...
#define EAST_RX_SWITCH (unsigned char)((0 == (EAST_RX_SWITCH_IN getBit EAST_RX_SWITCH_PIN)) ? 0 : 1)
...
#define EAST_RX_SWITCH_IS_HI (EAST_RX_SWITCH)
#define EAST_RX_SWITCH_IS_LO (0 == EAST_RX_SWITCH)
