...
SET(WRITE_FLASH  /bin/bash ${PROJECTS_SOURCE_ROOT}/avr-common/scripts/write_flash.sh  ${PROGRAMMER} ${PROGRAMMER_TARGET} ${PROGRAMMER_BAUD} ${PROGRAMMER_PORT} ${PROGRAMMER_EXTRA_FLAGS}  ${CMAKE_BINARY_DIR}/${BINARY})
SET(WRITE_FUSE   /bin/bash ${PROJECTS_SOURCE_ROOT}/avr-common/scripts/write_fuse.sh   ${PROGRAMMER} ${PROGRAMMER_TARGET} ${PROGRAMMER_BAUD} ${PROGRAMMER_PORT} ${PROGRAMMER_EXTRA_FLAGS}  ${CMAKE_BINARY_DIR}/${BINARY} )
SET(VERIFY_FLASH /bin/bash ${PROJECTS_SOURCE_ROOT}/avr-common/scripts/verify_flash.sh ${PROGRAMMER} ${PROGRAMMER_TARGET} ${PROGRAMMER_BAUD} ${PROGRAMMER_PORT} ${PROGRAMMER_EXTRA_FLAGS}  ${CMAKE_BINARY_DIR}/${BINARY}.flash)
SET(ERASE_FLASH  /bin/bash ${PROJECTS_SOURCE_ROOT}/avr-common/scripts/erase_flash.sh  ${PROGRAMMER} ${PROGRAMMER_TARGET} ${PROGRAMMER_BAUD} ${PROGRAMMER_PORT} ${PROGRAMMER_EXTRA_FLAGS})
