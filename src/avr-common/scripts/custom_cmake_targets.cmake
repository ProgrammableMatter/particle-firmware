...
SET(WRITE_FLASH_PROGRAMMER2 /bin/bash ${PROJECTS_SOURCE_ROOT}/avr-common/scripts/write_flash.sh ${PROGRAMMER} ${PROGRAMMER_TARGET} ${PROGRAMMER_BAUD} ${PROGRAMMER_PORT2} ${PROGRAMMER_EXTRA_FLAGS} ${CMAKE_CURRENT_BINARY_DIR}/${BINARY} ${POST_PROGRAMMING_COMMAND})
SET(WRITE_FLASH_PROGRAMMER3 /bin/bash ${PROJECTS_SOURCE_ROOT}/avr-common/scripts/write_flash.sh ${PROGRAMMER} ${PROGRAMMER_TARGET} ${PROGRAMMER_BAUD} ${PROGRAMMER_PORT3} ${PROGRAMMER_EXTRA_FLAGS} ${CMAKE_CURRENT_BINARY_DIR}/${BINARY} ${POST_PROGRAMMING_COMMAND})
...
add_custom_command(OUTPUT write_flash2
        # DEPENDS __clear_cmake_cache
        COMMAND ${WRITE_FLASH_PROGRAMMER2}
        )
add_custom_target(${PROJECT_NAME}_flash2 DEPENDS write_flash2 ${BINARY})

add_custom_command(OUTPUT write_flash3
        # DEPENDS __clear_cmake_cache
        COMMAND ${WRITE_FLASH_PROGRAMMER3}
        )
add_custom_target(${PROJECT_NAME}_flash3 DEPENDS write_flash3 ${BINARY})
