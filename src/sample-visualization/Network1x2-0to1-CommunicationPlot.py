...
if __name__ == "__main__":
    ...
    transmissionWirefilter = Filter.SampleFilter(domain="WIRE", name="tx-south", nodeId=0)
    ...
    # reception wire plot
    receptionWireFilter = Filter.SampleFilter(domain="WIRE", name="rx-south", nodeId=0)
