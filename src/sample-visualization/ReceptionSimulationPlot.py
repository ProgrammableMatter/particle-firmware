...
if __name__ == "__main__":
    ...
    pltr.addPlot(filter, plotter, title="[0] SRAM[int16-out]", nodeId=0, domain="SRAM", name="int16-out")
    ...
    pltr.addPlot(filter, plotter, title="[0] SRAM[char-out] - rx states", nodeId=0, domain="SRAM", name="char-out")
