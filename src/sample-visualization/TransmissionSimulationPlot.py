...
if __name__ == "__main__":
    ...
    pltr.addPlot(dataFilter, dataPlotter, title="SRAM[int16-out]", nodeId=0, domain="SRAM", name="int16-out")
    ...
    pltr.addPlot(dataFilter, dataPlotter, title="SRAM[char-out] - rx states", nodeId=0, domain="SRAM", name="char-out")

    dataPlotter.setWindowTitle("Transmission Simulation")
